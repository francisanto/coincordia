...
MONGODB_URI=${process.env.MONGODB_URI || "mongodb://localhost:27017/concordia"}
MONGODB_DB_NAME=${process.env.MONGODB_DB_NAME || "concordia"}
...
`
    ...
    console.log("3. Configure MongoDB credentials in your backend .env file")
